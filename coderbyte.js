...
coderbyte.getFactorial = function(number) {
...
coderbyte.getLongestWord = function(sentence) {
...
coderbyte.changeLetters = function(string) {
...
coderbyte.addNumbers  = function(number) {
...
coderbyte.capitalizeLetters = function(sentence) {
...
coderbyte.compareNumbers = function(number1, number2) {
...
coderbyte.countVowels = function(string) {
...
coderbyte.insertDashes = function(number) {
...
coderbyte.addNumbersAsString = function(string) {
